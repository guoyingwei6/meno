        ...
        <div style={{ overflowX: 'auto', paddingBottom: 4 }}>
          <div style={{ display: 'inline-flex', gap: 0 }}>
            ...
            <div>
                ...
                {weeks.map((week, wi) => (
                  <div key={wi} style={{ display: 'flex', flexDirection: 'column', gap: CELL_GAP }}>
                    {Array.from({ length: 7 }, (_, dow) => {
                      ...
                      if (!cell) return <div key={dow} style={{ width: CELL_SIZE, height: CELL_SIZE }} />;
                      return (
                        <div
                          key={dow}
              ...
              {/* Month labels */}
              <div style={{ position: 'relative', height: 20, marginTop: 4, width: gridWidth }}>
                {monthLabels.map((ml) => (
                  <span
            ...
            {/* Day labels on right */}
            <div style={{ display: 'flex', flexDirection: 'column', gap: CELL_GAP, marginLeft: 6 }}>
